 ...
 * @NotThreadSafe
 */
public class ModdedZipArchiveOutputStream extends ArchiveOutputStream {
     ...
     */
    public ModdedZipArchiveOutputStream(OutputStream out) {
        this.out = out;
        this.raf = null;
    }
     ...
     */
    public ModdedZipArchiveOutputStream(File file) throws IOException {
        OutputStream o = null;
     ...
     * #ModdedZipArchiveOutputStream(java.io.File) File-arg constructor}) -
